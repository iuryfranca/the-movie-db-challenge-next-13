...
export function CardMovieSkeleton() {
  return (
    <div className='flex w-full sm:w-44 sm:flex-col'>
      ...
      <div className='relative flex h-36 w-full flex-col items-center justify-between gap-2 rounded-b-md rounded-r-md rounded-l-none border-2 bg-slate-900 p-2 pt-5  dark:bg-white sm:h-24 sm:rounded-t-none sm:rounded-b-md sm:pt-8'>
