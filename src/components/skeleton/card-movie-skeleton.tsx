...
export function CardMovieSkeleton() {
  return (
    <div className='flex w-full sm:w-[185px] sm:flex-col'>
      ...
      <Skeleton className='h-36 w-36 rounded-l-md rounded-b-none rounded-r-none dark:bg-slate-400 sm:h-[278px] sm:w-full sm:rounded-b-none sm:rounded-t-md' />
