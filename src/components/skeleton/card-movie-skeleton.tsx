...
export function CardMovieSkeleton() {
  return (
    <div className='flex w-full sm:w-48 sm:flex-col'>
      ...
      <div className='relative flex h-36 w-full flex-col items-center justify-between gap-2 rounded-b-md rounded-r-md rounded-l-none bg-slate-900 p-2 pt-5 dark:bg-white sm:h-28 sm:rounded-t-none sm:rounded-b-md sm:pt-8'>
